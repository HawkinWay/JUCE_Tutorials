...
class SimpleNoiseApplication : public juce::JUCEApplication {
public:
    SimpleNoiseApplication() = default;

    const String getApplicationName() override { return "SimpleNoise"; }
    const String getApplicationVersion() override{ return "1.0.0"; };

    void initialise(const String &commandLineParameters) override {
        mainWindow.reset(new SimpleNoiseApplicationWindow("SimpleNoise", std::make_unique<SimpleNoise>(), *this));
    }
...
START_JUCE_APPLICATION (SimpleNoiseApplication)
